      ...
      <div className="container mx-auto px-4 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Our mission is simple: To provide the world with the purest, highest-quality natural ingredients while empowering the farmers who grow them.
            </p>
            ...
            <div className="grid grid-cols-2 gap-6 pt-6">
               <div className="space-y-2">
                 ...
                 <p className="text-sm text-muted-foreground">Market Experience</p>
               </div>
               <div className="space-y-2">
               ...
               <div className="space-y-2">
                 ...
                 <p className="text-sm text-muted-foreground">Annual Trade Value</p>
               </div>
            </div>
          </div>
          
          <div className="bg-secondary rounded-lg p-8 space-y-6">
             <h3 className="font-serif text-2xl font-bold text-primary mb-4">Certifications & Compliance</h3>
             <ul className="space-y-4">
               <li className="flex items-center gap-3">
                 <CheckCircle2 className="h-5 w-5 text-green-600" />
                 <span className="font-medium">ISO 22000:2018 (Food Safety Management)</span>
               </li>
               <li className="flex items-center gap-3">
                 <CheckCircle2 className="h-5 w-5 text-green-600" />
               ...
               <li className="flex items-center gap-3">
                 <CheckCircle2 className="h-5 w-5 text-green-600" />
                 <span className="font-medium">Organic Certified (NPOP/NOP)</span>
               </li>
               <li className="flex items-center gap-3">
                 <CheckCircle2 className="h-5 w-5 text-green-600" />
             ...
             <Button className="w-full mt-4" variant="outline">Request Copies of Certificates</Button>
          </div>
        </div>
      </div>
    </Layout>
